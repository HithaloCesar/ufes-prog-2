...
/**
 * Função que lê uma data no formato dd/mm/aaaa e retorna a Data lida
 */
Data lerData();

/**
 * Função que imprime uma data no formato dd/mm/aaaa com \n no final.
 */
...
/**
 * Função que calcula a diferença de anos entre duas datas da mesma forma que
 * calculamos aniversários.
 *
