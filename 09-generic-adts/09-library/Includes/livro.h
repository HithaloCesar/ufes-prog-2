...
/**
 * @brief Função que lê os dados de um livro da entrada padrão de acordo com a
...
/**
 * @brief Função que compara o autor de um livro com uma chave.
 *        Essa chave é recebida como um ponteiro void.
 *        Faça a manipulação necessária para comparar o autor do livro com a
 *        chave.
 *
...
/**
 * @brief Função que compara o ano de um livro com uma chave.
 *        Essa chave é recebida como um ponteiro void.
 *        Faça a manipulação necessária para comparar o ano do livro com a
 *        chave.
 *
 * @param dado Ponteiro para o livro.
 * @param chave Ponteiro para a chave de comparação.
 ...
 *        Dica: veja os casos de teste para entender o formato de saída e não
 *        perder tempo.
 *
