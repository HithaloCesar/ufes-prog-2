 ...
 *
 * @return Ponteiro para o filme criado ou encerra caso não seja possível
 *         alocar memória.
 */
 ...
 * @return 1 se o filme possui o código passado como parâmetro, 0 caso
 *         contrário.
 */
int EhMesmoCodigoFilme(tFilme *filme, int codigo);

/**
 * @brief Incrementa a quantidade alugada e decrementa a quantidade em estoque
 *        do filme.
 *
 * @param filme Ponteiro para o filme.
 */
...
/**
 * @brief Decrementa a quantidade alugada e incrementa a quantidade em estoque
 *        do filme.
 *
 * @param filme Ponteiro para o filme.
 */
 ...
 * @return 1 se o nome do primeiro filme for maior que o nome do segundo filme,
 *         -1 se o nome do primeiro filme for menor que o nome do segundo
 *         filme, 0 se os nomes forem iguais.
 */
