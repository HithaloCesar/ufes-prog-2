 ...
 * Os ponteiros devem ser inicializados com NULL e os campos numéricos com o
 * valor -1.
...
/**
 * @brief Apaga toda a memória alocada dinamicamente para guardar as
...
/**
 * @brief Lê um candidato. O número de votos de um candidato deve ser zerado
 *        aqui.
...
/**
 * @brief Verifica se dois candidatos são iguais (dica: utilize para verificar
 *        se houve empate).
...
/**
 * @brief Calcula o percentual de votos do candidato em relação ao total de
 *        votos (do mesmo cargo).
 * @param candidato Candidato a ser verificado.
