 ...
 *        Os ponteiros devem ser inicializados com NULL e os campos numéricos
 *        com o valor -1.
...
/**
 * @brief Apaga/Libera toda a memória alocada dinamicamente para armazenar
 *        dados de um eleitor
...
/**
 * @brief Verifica se dois eleitores são iguais (dica: use para verificar se
 *        algum eleitor tentou registar um voto novamente).
