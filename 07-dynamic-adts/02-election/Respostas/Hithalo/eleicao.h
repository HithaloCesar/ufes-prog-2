 ...
 *        armazenam votos).
 *        Ainda nessa função, é lido a quantidade de candidatos e os candidatos
 *        são lidos e armazenados
 *        A memória necessária para os vetores "presidentes", "governadores"
 *        deve ser alocada aqui.
 ...
 *        Nessa função, é lido a quantidade de eleitores e os eleitores são
 *        lidos e armazenados.
...
/**
 * @brief Imprime o resultado da eleição na tela a partir da aparucao dos
 *        votos.
