...
/**
 * @brief Cria uma nova tela com a altura e largura especificadas e botões
 *        vazios (zero).
 *
...
/**
 * @brief Desenha a tela especificada na saída padrão se houver botões
 *        registrados.
 *
...
/**
 * @brief Espera o usuário clicar em um botão da tela especificada e executa a
 *        ação correspondente.
 *        Se o usuário clicar em um botão que não existe, o programa é
 *        encerrado.
 *
