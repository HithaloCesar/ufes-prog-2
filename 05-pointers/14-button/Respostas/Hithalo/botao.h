...
typedef struct {
    ...
    char corHex[7];
    int tipo;
    void (*executa)(void); // ponteiro para função que irá executar um evento
                           // quando o botão for clicado
} Botao;

/**
 * @brief Define o texto exibido no botão especificado se o novo texto for
 *        menor do que o tamanho máximo permitido.
 *        se o novo texto for maior do que o tamanho máximo permitido, o
...
/**
 * @brief Define o tamanho da fonte do texto exibido no botão especificado se o
 *        novo tamanho for maior do que zero.
...
/**
 * @brief Define o tipo de evento que o botão especificado pode receber se o
 *        novo tipo for válido.
 *
...
/**
 * @brief Executa a função associada ao botão especificado de acordo com o tipo
 *        de evento que o botão pode receber.
