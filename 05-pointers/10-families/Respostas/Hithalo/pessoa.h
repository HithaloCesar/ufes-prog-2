 ...
 * e inicializa os ponteiros para pai, mae e irmao com NULL.
 *
 ...
 * Dica: use a função VerificaSeTemPaisPessoa para verificar se a pessoa tem
 * pai e/ou mae associado(s).
