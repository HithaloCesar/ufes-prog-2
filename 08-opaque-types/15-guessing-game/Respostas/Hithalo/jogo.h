 ...
 *
 * @param jogo A variável do tipo jogo que tem os dados do jogo armazenados.
 *             O cálculo será armazenado nela.
 */
void CalculaValorASerAdivinhado(tJogo *jogo, int n);

/**
 * @brief Calcula o número de tentativas que o usuário irá ter para acertar o
 *        número.
 *        O cálculo deve ser feito como descrito no roteiro.
 *
 * @param jogo A variável do tipo jogo que tem os dados do jogo armazenados.
...
/**
 * @brief Executa o jogo. Calcula o que for necessário e lê as tentativas,
 *        fazendo as devidas verificações.
 *
 * @param jogo A variável do tipo jogo que tem os dados do jogo armazenados.
 * @return 1 se o usuário venceu o jogo ou 0 caso contrário.
 */
